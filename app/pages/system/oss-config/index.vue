...
const booleanConfig = {
  ...
  '1': { i18nKey: 'common.yesOrNo.yes', color: 'primary' }
} as const

const accessPolicyConfig = {
  '0': { i18nKey: 'module.system.ossConfig.accessPolicyPrivate', color: 'warning' },
  '1': { i18nKey: 'module.system.ossConfig.accessPolicyPublic', color: 'primary' }
} as const
