      ...
      >
        <template #header>
          <TableHeaderOperation
              ...
              :add-permission="roleMenuPermissions.codes.add"
              :delete-permission="roleMenuPermissions.codes.del"
...
const columns = computed<TableColumn<SysRoleMenuDto>[]>(() => {
  const actionColumn: TableColumn<SysRoleMenuDto> = {
    id: 'actions',
    ...
    cell: ({ row }) => {
      ...
      if (roleMenuPermissions.canEdit.value) {
      ...
      if (roleMenuPermissions.canDel.value) {
  ...
  return [
    ...(roleMenuPermissions.canDel.value ? [selectionColumn] : []),
    {
      id: 'index',
    ...
    ...(roleMenuPermissions.canOperate.value ? [actionColumn] : [])
  ]
})
